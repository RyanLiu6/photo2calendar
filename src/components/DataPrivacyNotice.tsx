  ...
  return (
    ...
    >
      ...
      <p className={`${textStyle} text-sm text-slate-500 dark:text-slate-400`}>
        We use OCR.space for text extraction, and the processed schedule is stored securely on our
        server.
        <br />
        <br />
        ...
        <br />
        <br />
        No data is sent or kept on any server past that point. If you wish to keep your schedule,
